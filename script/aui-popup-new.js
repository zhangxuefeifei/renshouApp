    ...
    auiPopup.prototype = {
        ...
        open: function(params, callback) {
            ...
            if (!self.maskDiv) {
                ...
                self.maskDiv.className = "aui-mask aui-pop-mask";
            ...
            if (self.buttons && self.buttons.length) {
                ...
                for (var i = 0; i < self.buttons.length; i++) {
                    buttonsHtml += '<li class="aui-list-item aui-list-item-middle" tapmode>';
            ...
            if (popupButtons && popupButtons.length > 0) {
                setTimeout(function() {
                    self.maskDiv.ontouchstart = function() {
                        self.close();
                        return;
                    };
                    for (var ii = 0; ii < popupButtons.length; ii++) {
                        (function(e) {
                            popupButtons[e].ontouchstart = function() {
